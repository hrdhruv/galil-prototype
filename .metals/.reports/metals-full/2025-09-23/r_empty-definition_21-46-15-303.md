error id: file://<WORKSPACE>/galil-assembly/src/main/scala/csw/proto/galil/assembly/GalilAssembly.scala:deploy.
file://<WORKSPACE>/galil-assembly/src/main/scala/csw/proto/galil/assembly/GalilAssembly.scala
empty definition using pc, found symbol in pc: deploy.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/concurrent/duration/csw/framework/deploy.
	 -csw/framework/deploy.
	 -scala/Predef.csw.framework.deploy.
offset: 343
...
import csw.framework.d@@eploy.containercmd.ContainerCmd
...
private class GalilAssemblyHandlers(ctx: ActorContext[TopLevelActorMessage], cswServices: CswContext)
  ...
  override def initialize(): Unit = {
    log.debug("Initialize Galil assembly")
  }
